...
`ifndef FMA_EXPECTED_RECORD_SVH
`define FMA_EXPECTED_RECORD_SVH

class fma_expected_record extends uvm_sequence_item;
  ...
  `uvm_object_utils_begin(fma_expected_record)
  ...
  function new(string name = "fma_expected_record");
    super.new(name);
  endfunction
endclass
